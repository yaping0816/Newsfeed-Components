...
function articleMaker(artObject){
  // instantiate all the elements needed
  ...
  art.appendChild(artExpandButton);
  // add proper class names
  art.classList.add('article');
  artDate.classList.add('date');
  artExpandButton.classList.add('expandButton')
  // add content
  artTitle.textContent = artObject.title;
  artDate.textContent = artObject.date;
  para1.textContent = artObject.firstParagraph;
  para2.textContent = artObject.secondParagraph;
  para3.textContent = artObject.thirdParagraph;
  artExpandButton.textContent = '+';
  // step 2
  artExpandButton.addEventListener('click', event =>{
...
// step 5 add new objects to data array